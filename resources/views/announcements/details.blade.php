		...
		<div class="col-12 col-md-6 card_detalle">
			...
			<div id="carrusell-detail" class="carousel cards-detalles carousel-light slide" data-bs-ride="carousel">
				<div class="carousel-indicators">
					@foreach ($announcement->images as $i)
						<button type="button" data-bs-target="#carrusell-detail" data-bs-slide-to="0" @if ($loop->first) class="active" @endif aria-current="true" aria-label="Slide 1"></button>
					@endforeach
				</div>
