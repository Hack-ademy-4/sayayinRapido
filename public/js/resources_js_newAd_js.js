(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_newAd_js"],{

/***/ "./resources/js/newAd.js":
/*!*******************************!*\
  !*** ./resources/js/newAd.js ***!
  \*******************************/
...
function init(token) {
  ...
  var myDropzone = new (dropzone__WEBPACK_IMPORTED_MODULE_1___default())('#drop', {
    url: '/new/images',
    params: {
      _token: token,
