(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_my-dropzone_js"],{
...
function init(token) {
  ...
  var myDropzone = new (dropzone__WEBPACK_IMPORTED_MODULE_1___default())('#drophere', {
    url: '/new/images',
    params: {
      _token: token,
